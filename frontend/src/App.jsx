...
export default function App() {
  ...
  return (
    <div className="w-screen h-screen flex flex-row overflow-hidden bg-black font-sans text-white">
      ...
      <div className="w-1/3 h-full border-r border-cyan-900/50 relative">
        ...
        <Canvas camera={{ position: [0, 60, 0], fov: 45 }}>
          <Scene gameState={gameState} worldSize={ENV_SIZE} onPlaceObstacle={handlePlaceObstacle} />
          <MapCamera stateRef={gameState} worldSize={ENV_SIZE} />
        </Canvas>
      </div>
      ...
      <div className="w-2/3 h-full relative">
        ...
        >
          <Scene gameState={gameState} worldSize={ENV_SIZE} />
